import FormFileLaporan from "../../atoms/form/uploadfile";
...
const AddFileModal = ({
  ...
  return (
    <>
      {showModal ? (
        <>
          <div className="flex h-fit lg:w-1/2 justify-center items-center overflow-x-hidden overflow-y-auto fixed inset-0 z-50 w-fit m-auto">
